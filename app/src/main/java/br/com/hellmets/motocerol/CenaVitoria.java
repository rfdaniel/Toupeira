...
public class CenaVitoria extends AGScene {
    ...
    AGSprite imgVencedorFundo = null;

    CenaVitoria(AGGameManager manager){
        super(manager);
    }
    ...
    public void init() { //Chamado toda vez que a cena Abertura é mostrada (iniciada). Aloca recursos
        ...
        //IMAGEM VENCEDOR
        imgVencedorFundo = this.createSprite(R.mipmap.img_vencedor_fundo, 1, 1);
        imgVencedorFundo.setScreenPercent(100, 100); //Tamanho da imagem
        imgVencedorFundo.vrPosition.setXY (AGScreenManager.iScreenWidth/2, AGScreenManager.iScreenHeight/2);
