...
public class SobreJogo  extends AGScene {

    AGSprite btnGoBack = null;
    AGSprite imgSobreFundo = null;

    SobreJogo(AGGameManager manager){
        super(manager);
    }
    ...
    public void init() { //Chamado toda vez que a cena Abertura é mostrada (iniciada). Aloca recursos
        ...
        //IMAGEM DERROTADO
        imgSobreFundo = this.createSprite(R.mipmap.img_sobre_fundo, 1, 1);
        imgSobreFundo.setScreenPercent(100, 100); //Tamanho da imagem
        imgSobreFundo.vrPosition.setXY (AGScreenManager.iScreenWidth/2, AGScreenManager.iScreenHeight/2);
